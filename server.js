...
var TwitterStreamService = function(server){
	...
	var twitter_api = 
			new twitter({
				consumer_key: 'hJPBcd9DtL1nyhGPIxCAPk0yr',
				consumer_secret: 'znKrcaV8iliDCN0I0llMFw5vQy1PESakZVtG5JCL2CVEtAHruy',
				access_token: '235178974-HPBPwGfoP7VPf61Uv2hbkWnIgLwCeV2Rhjx1EcfG',
				access_token_secret: 'e7IFuFx3JUbxCr9WBDrRdO7rmHzJ4PgdLP9PlYWyKa92B'
			});
